...
# Carregar dataset
df = pd.read_csv (r'C:\Users\jasmi\OneDrive\Área de Trabalho\RNNP_DS\PyTorch\heart.csv')
df = df.dropna()
...
train_labels = t.as_tensor(train_set.DEATH_EVENT.values).to(device)
test_labels = t.as_tensor(test_set.DEATH_EVENT.values).to(device)
